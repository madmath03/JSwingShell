...
public interface IJssController {
    ...
    /**
     * Extract the command line, interpret the command and return its execution
     * status.
     *
     * @return a command's execution status.
     *
    ...
    public static enum PublicationLevel {
         ...
         *
         * <p>
         * This is used to return the results of a successful execution.</p>
         */
        SUCCESS,
        /**
         * Fatal error.
         *
         * <p>
         * This is typically used for an unexpected error which prevented the
         * proper execution of the program.</p>
         */
        FATAL_ERROR,
        /**
         * Error.
         *
         * <p>
         * This is typically used for an error which was expected but prevented
         * the proper execution of the program.</p>
         */
        ERROR,
        /**
         * Warning.
         *
         * <p>
         * This is typically used for an error which was expected but did not
         * prevented the proper execution of the program.</p>
         */
        WARNING,
        /**
         * Information.
         *
         * <p>
         * This is typically used for displaying useful informations to the user
         * about the execution of the program.</p>
         */
        INFO,
        /**
         * Debug.
     ...
     *
     * <p>
     * If the publication level is lesser or equal to the shell's level, the
     * message shall not be published.</p>
     *
     * @param level the level of the publish.
     * @param message the message to publish.
     * @return {@code true} if the message was published, {@code false}
     * otherwise.
     */
