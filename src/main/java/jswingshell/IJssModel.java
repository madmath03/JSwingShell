 ...
 *
 * <p>
 * A shell model stores all actions available for the shell environment, as well as methods to
...
public interface IJssModel {
   ...
   *
   * @param action action whose presence in the shell available actions is to be tested
   * @return {@code true} if the given action belongs to the shell available actions.
   */
   ...
   *
   * @param actions collection of actions to be checked for containment in the shell available
   *        actions
   * @return {@code true} if the given actions belongs to the shell available actions.
   */
  public boolean containsAll(Collection<? extends IJssAction> actions);

  /**
   * Retains only the actions in this shell available actions that are contained in the specified
   * collection of actions.
   *
   * @param actions collection containing actions to be retained in the shell available actions
   * @return {@code true} if the given actions belongs to the shell available actions.
   */
  ...
  /**
   * Returns the number of available actions in this shell model (its cardinality).
   *
   * <p>
   * If this set contains more than <tt>Integer.MAX_VALUE</tt> elements, returns
