 ...
 *
 * <p>
 * Note: these instances may have a natural ordering that is inconsistent with equals. Natural
 * ordering of shell actions is often done on their identifier.
 * </p>
 *
...
public interface IJssAction extends Action, Comparable<IJssAction> {
   ...
   *
   * <p>
   * If this command has no identifiers, returns {@code null}.
   * </p>
   *
   * <p>
   * The default identifier is usually the first of the command identifiers.
   * </p>
   *
   * @return the default identifier for this shell command, {@code null} if none
   *
  ...
  /**
   * Get a displayable {@code String} of the allowed identifiers for this shell command.
   *
  ...
  /**
   * Run the action for its default shell controller and its default arguments.
   *
