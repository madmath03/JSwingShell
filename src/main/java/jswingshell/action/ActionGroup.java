 ...
 *
 * <p>
 * Creating a set of actions with the same {@code ActionGroup} object means that turning "on" one of
 * those actions turns off all other actions in the group.
 * </p>
 * <p>
 * A {@code ActionGroup} can be used with any set of objects that inherit from
 * {@code AbstractJssSwitchAction}.
 * </p>
 * <p>
 * Initially, all actions in the group are unselected.
 * </p>
 *
...
public class ActionGroup implements Serializable {
  ...
  /**
   * Clears the selection such that none of the actions in the {@code ActionGroup} are selected.
   */
  ...
  /**
   * Sets the selected value for the {@code AbstractJssSwitchAction}. Only one action in the group
   * may be selected at a time.
   *
   * @param a the {@code AbstractJssSwitchAction}
   * @param b {@code true} if this action is to be selected, otherwise {@code false}
   */
   ...
   *
   * <p>
   * Enabling or disabling an {@code ActionGroup} consists in enabling/disabling all actions
