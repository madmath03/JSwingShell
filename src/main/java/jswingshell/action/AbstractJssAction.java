...
/**
 * A {@code AbstractJssAction} is an operation that can be called through an id and some parameters
 * if needed.
 *
 * <p>
...
public abstract class AbstractJssAction extends AbstractAction
   ...
   * </p>
   *
   * @see AbstractJssAction#AbstractJssAction(jswingshell.IJssController, java.lang.String[])
   */
  ...
  /**
   * Creates an {@code AbstractShellAction} with the specified default shell controller and default
   * arguments.
   *
  ...
  /**
   * Creates an {@code AbstractShellAction} with the specified name, default shell controller and
   * default arguments.
   *
  ...
  /**
   * Creates an {@code AbstractShellAction} with the specified name, small icon, default shell
  ...
  /**
   * Construct an array of arguments to pass to the command based on an {@code ActionEvent}.
   *
   * @param e an {@code ActionEvent}.
   *
   * @return an array of arguments to pass to the command, or {@code null} if no arguments were
   *         extracted.
   */
   ...
   *
   * <p>
   * The comparison is done on the actions' command identifiers found, thus allowing for
   * lexicographically sorting of the commands.
   * </p>
   *
  ...
  public int compareTo(IJssAction o) {
    ...
    int thisActionIdentifiersSize =
        thisActionIdentifiers != null ? thisActionIdentifiers.length : 0,
        otherActionIdentifiersSize =
            otherActionIdentifiers != null ? otherActionIdentifiers.length : 0;
