 ...
 * 
 * The caret is rendered as a filled rectangle in the color specified by the 
 * CaretColor property of the associated JTextComponent.  
 * It can blink at the rate specified by the BlinkRate property.
 * 
 * @author Kim Topley
