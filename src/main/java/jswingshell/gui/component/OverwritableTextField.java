...
/**
 * A {@code OverwritableTextField} is a lightweight component that allows the editing of a single
 * line of text, with overriding mode management.
 * 
 * <p>
 * It is an extended version of the {@code OverwritableTextField} by Kim Topley from <em>Core SWING
 * Advanced Programming</em>. This version comes with all the constructors from the
 * {@link javax.swing.JTextField} by reusing its basic caret as the insert caret.
 * </p>
 * 
 * <p>
 * The insert caret is initialized with the {@code JTextField}'s basic caret. The insert caret can
 * be changed using the {@link #setInsertCaret(javax.swing.text.Caret)} method.
 * </p>
 * 
 * <p>
...
public class OverwritableTextField extends JTextField {
  ...
  /**
   * Constructs a new <code>OverwritableTextField</code> that uses the given text storage model and
   * the given number of columns. This is the constructor through which the other constructors feed.
   ...
   *        <code>columns</code> is set to zero, the preferred width will be whatever naturally
  ...
  public static final String toggleOverwriteAction =
      "toggle-overwrite-" + OverwritableTextField.class.toString();
