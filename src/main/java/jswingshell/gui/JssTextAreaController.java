...
public class JssTextAreaController extends AbstractJssController {
  ...
  public String getCommandLine() {
    ...
    if (commandLinePosition > -1 && shellText != null
        && commandLinePosition <= shellText.length()) {
    ...
    switch (keyCode) {
      ...
      case KeyEvent.VK_BACK_SPACE: {
        ...
        if (getView().getJShellTextArea().getSelectedText() == null
            && getCaretPosition() <= startOfCommandfLine) {
          evt.consume();
        }
      }
        break;
  ...
  /**
   * <em>Fix</em> the current selection to ensure that any input will not edit the <em>past</em>
   * shell data or compromise the command line itself.
   */
  ...
  /**
   * Sets the background color and the current color used to render the selected text of this
   * component.
   *
   * <p>
   ...
   *
   * <p>
   * Setting the color to {@code null} is the same as {@code Color.black}. Setting the color results
   * in a PropertyChange event ("selectedTextColor") being fired.
   * </p>
   *
  ...
  /**
   * Sets the foreground color and the current color used to render the selection of this component.
   *
   * <p>
   * It is up to the look and feel to honor this property, some may choose to ignore it.
   * </p>
   *
   * <p>
   * Sets the current color used to render the selection. Setting the color to {@code null} is the
   * same as setting {@code Color.white}. Setting the color results in a PropertyChange event
   * ("selectionColor").
   * </p>
   *
   ...
   *
   * <p>
   * If the document is null or doesn't have a tab setting, return a default of 8.
   * </p>
   *
   ...
   *
   * <p>
   * This will be multiplied by the maximum advance for variable width fonts. A PropertyChange event
   ...
   *
   * <p>
   * This removes cached row height and column width so the new font will be reflected, and calls
   * revalidate().
   * </p>
   *
